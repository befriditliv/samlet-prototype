...
export const DebriefForm = ({ meetingId, onBack, onSave }: DebriefFormProps) => {
  ...
  if (phase === 'template') {
    return (
      <div className="app-shell min-h-screen bg-background animate-fade-in sm:border-x-2 sm:border-border/50">
        {/* Header */}
  ...
  return (
    <div className="app-shell min-h-screen bg-background flex flex-col sm:border-x-2 sm:border-border/50">
      {/* Minimal Header */}
      <div className="sticky top-0 z-10 bg-white px-4 sm:px-6 py-4 border-b border-border shadow-sm">
        <div className="flex items-center gap-3">
          <Button
