      ...
      <div className="flex items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-1 shrink-0">
          ...
          <div className="relative shrink-0">
            <div className="absolute inset-0 -m-2.5 rounded-[1.7rem] bg-primary/10 blur-md" aria-hidden />
            <img
              src={jarvisLogo}
              alt="Jarvis"
              className="relative h-[60px] w-[60px] rounded-[1.3rem] shadow-[var(--shadow-soft)] ring-1 ring-white/40"
            />
          </div>
        </div>
      </div>
