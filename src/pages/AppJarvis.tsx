...
const AppJarvis = () => {
  ...
  return (
    <div className="app-shell min-h-[100dvh] bg-background flex flex-col sm:border-x-2 sm:border-border/50">
      ...
      <div className="fixed bottom-16 left-0 right-0">
        <div className="app-shell-bar px-5 pb-3 pt-3 bg-background/70 backdrop-blur-2xl border-t border-border/50 sm:border-x-2 sm:border-border/50">
