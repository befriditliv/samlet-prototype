          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <Card>
              ...
              <CardContent className="space-y-6">
                <div>
                  <h4 className="text-sm font-medium text-foreground mb-2">Emnebeskrivelse</h4>
                ...
                <div>
                  ...
                  <ul className="space-y-2 text-sm text-muted-foreground">
                    <li className="flex items-start gap-2">
                      ...
                      Sammenligning med tidligere perioder viser ingen ændringer, da der heller ikke er registreret emner i sammenligningsdata.
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="text-primary mt-1">•</span>
                      Ingen nye emner er opstået, og ingen tidligere emner er blevet løst eller adresseret.
                    </li>
                  </ul>
                </div>
                ...
                <div>
                  ...
                  <ul className="space-y-2 text-sm text-muted-foreground">
                    <li className="flex items-start gap-2">
                      <span className="text-primary mt-1">•</span>
                      For Ozempic er der ingen indikationer på nye indvendinger, barrierer eller feedback, 
                      hvilket kan tolkes som stabilitet, men også som et potentielt behov for at styrke digitalt engagement og dataindsamling.
                    </li>
                  </ul>
                </div>
                ...
                <div>
                  ...
                  <ul className="space-y-2 text-sm text-muted-foreground">
                    <li className="flex items-start gap-2">
                      <span className="text-primary mt-1">•</span>
                      Vurder om nuværende digitale engagement-initiativer er tilstrækkelige til at fremme dialog og indsamling af relevante indsigter.
                    </li>
                  </ul>
                </div>
              </CardContent>
              ...
              <CardContent>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  <div className="p-4 rounded-lg border bg-muted/30">
                    <h5 className="text-sm font-medium text-foreground mb-2">Regionens fortolkning</h5>
                    <p className="text-xs text-muted-foreground">
                      Indvendinger og bekymringer om regionens fortolkning af klausuler og retningslinjer.
                    </p>
                  </div>
                  <div className="p-4 rounded-lg border bg-muted/30">
                    <h5 className="text-sm font-medium text-foreground mb-2">Opstart af behandling</h5>
                    <p className="text-xs text-muted-foreground">
                      Ingen indvendinger eller bekymringer ved opstart af behandling.
                    </p>
                  </div>
                  <div className="p-4 rounded-lg border bg-muted/30">
                    <h5 className="text-sm font-medium text-foreground mb-2">Usikkerhed</h5>
                    <p className="text-xs text-muted-foreground">
                      Usikkerhed om tilskud, retningslinjer eller ansøgninger.
                    </p>
                  </div>
                </div>
              </CardContent>
